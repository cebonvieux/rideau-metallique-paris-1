...
export const metadata: Metadata = {
  title: `Motorisation Rideau Métallique Paris 1er (${siteConfig.postalCode})`,
  description: `Motorisation rideau métallique à ${siteConfig.city}. Automatisation de votre rideau. Télécommande, clavier à code, module connecté. Devis gratuit. ${siteConfig.phone}`,
  alternates: {
    canonical: `${siteConfig.url}/motorisation`,
  },
};
